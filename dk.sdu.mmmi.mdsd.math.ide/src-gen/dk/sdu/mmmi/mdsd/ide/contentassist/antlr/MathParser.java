...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getParanthesisAccess().getGroup(), "rule__Paranthesis__Group__0");
			...
			builder.put(grammarAccess.getExternalDefinitionAccess().getParametersAssignment_3_0(), "rule__ExternalDefinition__ParametersAssignment_3_0");
			builder.put(grammarAccess.getExternalDefinitionAccess().getParametersAssignment_3_1_1(), "rule__ExternalDefinition__ParametersAssignment_3_1_1");
			...
			builder.put(grammarAccess.getPrimaryAccess().getPAssignment_4_1(), "rule__Primary__PAssignment_4_1");
			builder.put(grammarAccess.getFunctionCallAccess().getExternalRefAssignment_1(), "rule__FunctionCall__ExternalRefAssignment_1");

...
public class MathPackageImpl extends EPackageImpl implements MathPackage
{
   ...
   */
  @Override
  public EReference getExternalDefinition_Parameters()
  {
    return (EReference)externalDefinitionEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EReference getParanthesis_P()
  {
   ...
   */
  @Override
  public EReference getFunctionCall_ExternalRef()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(externalDefinitionEClass, EXTERNAL_DEFINITION__PARAMETERS);
    ...
    createEReference(paranthesisEClass, PARANTHESIS__P);

    functionCallEClass = createEClass(FUNCTION_CALL);
    createEReference(functionCallEClass, FUNCTION_CALL__EXTERNAL_REF);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getExternalDefinition_Parameters(), this.getParameter(), null, "parameters", null, 0, -1, ExternalDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getParanthesis_P(), this.getExpression(), null, "p", null, 0, 1, Paranthesis.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(functionCallEClass, FunctionCall.class, "FunctionCall", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getFunctionCall_ExternalRef(), this.getExternalDefinition(), null, "externalRef", null, 0, 1, FunctionCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

...
public interface MathPackage extends EPackage
{
   ...
   * @ordered
   */
  int EXTERNAL_DEFINITION__PARAMETERS = 1;
   ...
   * @ordered
   */
  int PARANTHESIS__P = EXPRESSION_FEATURE_COUNT + 0;
  ...
  /**
   * The meta object id for the '{@link dk.sdu.mmmi.mdsd.math.impl.FunctionCallImpl <em>Function Call</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see dk.sdu.mmmi.mdsd.math.impl.FunctionCallImpl
   * @see dk.sdu.mmmi.mdsd.math.impl.MathPackageImpl#getFunctionCall()
   * @generated
   */
  int FUNCTION_CALL = 14;

  /**
   * The feature id for the '<em><b>External Ref</b></em>' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int FUNCTION_CALL__EXTERNAL_REF = EXPRESSION_FEATURE_COUNT + 0;
  ...
  /**
   * Returns the meta object for the containment reference list '{@link dk.sdu.mmmi.mdsd.math.ExternalDefinition#getParameters <em>Parameters</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Parameters</em>'.
   * @see dk.sdu.mmmi.mdsd.math.ExternalDefinition#getParameters()
   * @see #getExternalDefinition()
   * @generated
   */
  EReference getExternalDefinition_Parameters();
  ...
  /**
   * Returns the meta object for the containment reference '{@link dk.sdu.mmmi.mdsd.math.Paranthesis#getP <em>P</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>P</em>'.
   * @see dk.sdu.mmmi.mdsd.math.Paranthesis#getP()
   * @see #getParanthesis()
   * @generated
   */
  EReference getParanthesis_P();

  /**
   * Returns the meta object for class '{@link dk.sdu.mmmi.mdsd.math.FunctionCall <em>Function Call</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Function Call</em>'.
   * @see dk.sdu.mmmi.mdsd.math.FunctionCall
   * @generated
   */
  EClass getFunctionCall();

  /**
   * Returns the meta object for the reference '{@link dk.sdu.mmmi.mdsd.math.FunctionCall#getExternalRef <em>External Ref</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>External Ref</em>'.
   * @see dk.sdu.mmmi.mdsd.math.FunctionCall#getExternalRef()
   * @see #getFunctionCall()
   * @generated
   */
  EReference getFunctionCall_ExternalRef();

  /**
   * Returns the meta object for the containment reference list '{@link dk.sdu.mmmi.mdsd.math.FunctionCall#getArgs <em>Args</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Args</em>'.
   * @see dk.sdu.mmmi.mdsd.math.FunctionCall#getArgs()
   * @see #getFunctionCall()
   * @generated
   */
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference EXTERNAL_DEFINITION__PARAMETERS = eINSTANCE.getExternalDefinition_Parameters();
     ...
     * @generated
     */
    EReference PARANTHESIS__P = eINSTANCE.getParanthesis_P();

    /**
     * The meta object literal for the '{@link dk.sdu.mmmi.mdsd.math.impl.FunctionCallImpl <em>Function Call</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see dk.sdu.mmmi.mdsd.math.impl.FunctionCallImpl
     * @see dk.sdu.mmmi.mdsd.math.impl.MathPackageImpl#getFunctionCall()
    ...
    /**
     * The meta object literal for the '<em><b>External Ref</b></em>' reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference FUNCTION_CALL__EXTERNAL_REF = eINSTANCE.getFunctionCall_ExternalRef();

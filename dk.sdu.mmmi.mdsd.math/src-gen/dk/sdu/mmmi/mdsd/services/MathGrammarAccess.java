...
public class MathGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class PrimaryElements extends AbstractParserRuleElementFinder {
		...
		private final Action cParanthesisAction_4_0 = (Action)cGroup_4.eContents().get(0);
		private final Assignment cPAssignment_4_1 = (Assignment)cGroup_4.eContents().get(1);
		private final RuleCall cPParanthesisParserRuleCall_4_1_0 = (RuleCall)cPAssignment_4_1.eContents().get(0);
		...
		//{Paranthesis} p=Paranthesis
		public Group getGroup_4() { return cGroup_4; }
		
		//{Paranthesis}
		public Action getParanthesisAction_4_0() { return cParanthesisAction_4_0; }
		
		//p=Paranthesis
		public Assignment getPAssignment_4_1() { return cPAssignment_4_1; }
		
		//Paranthesis
		public RuleCall getPParanthesisParserRuleCall_4_1_0() { return cPParanthesisParserRuleCall_4_1_0; }
	}
	public class ParanthesisElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "dk.sdu.mmmi.mdsd.Math.Paranthesis");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FunctionCallElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "dk.sdu.mmmi.mdsd.Math.FunctionCall");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cFunctionCallAction_0 = (Action)cGroup.eContents().get(0);
		private final Assignment cExternalRefAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final CrossReference cExternalRefExternalDefinitionCrossReference_1_0 = (CrossReference)cExternalRefAssignment_1.eContents().get(0);
		private final RuleCall cExternalRefExternalDefinitionIDTerminalRuleCall_1_0_1 = (RuleCall)cExternalRefExternalDefinitionCrossReference_1_0.eContents().get(1);
		private final Keyword cLeftParenthesisKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Group cGroup_3 = (Group)cGroup.eContents().get(3);
		...
		//externalRef=[ExternalDefinition]
		public Assignment getExternalRefAssignment_1() { return cExternalRefAssignment_1; }
		
		//[ExternalDefinition]
		public CrossReference getExternalRefExternalDefinitionCrossReference_1_0() { return cExternalRefExternalDefinitionCrossReference_1_0; }
		
		//ID
		public RuleCall getExternalRefExternalDefinitionIDTerminalRuleCall_1_0_1() { return cExternalRefExternalDefinitionIDTerminalRuleCall_1_0_1; }
	...
	private final ParanthesisElements pParanthesis;
	...
	public MathGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pParanthesis = new ParanthesisElements();
	...
	//    '('Exp')'
	//;
	public ParanthesisElements getParanthesisAccess() {
		return pParanthesis;
	}
	
	public ParserRule getParanthesisRule() {
		return getParanthesisAccess().getRule();
	}

...
public class MathGenerator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    ...
    for (final MathExp exp : _filter) {
      String _name = exp.getName();
      String _plus = ("math_expression/" + _name);
      String _plus_1 = (_plus + ".java");
      fsa.generateFile(_plus_1, this.compile(exp));
    }
  }
  ...
  protected static String _computeExpression(final Paranthesis exp) {
    String _computeExpression = MathGenerator.computeExpression(exp.getP());
    String _plus = ("(" + _computeExpression);
    return (_plus + ")");
  }
    ...
    String _xblockexpression = null;
    {
      ...
      if (_greaterThan) {
        String _xblockexpression_1 = null;
        {
          ...
          String _substring = args.substring(0, _minus);
  ...
  public static String computeExpression(final EObject exp) {
    if (exp instanceof Div) {
      ...
      return _computeExpression((Paranthesis)exp);
